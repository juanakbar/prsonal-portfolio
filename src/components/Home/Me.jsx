...
export default function Me() {
    return (
        <div className='home__data'>
            <h1 className='home__title'>Hi, I'm Juan
                {/* Ignore Format */}
                <svg
                    width="36"
                    height="36"
            ...
            <p className='home__description'>I'm a Fullstack Developer with experience in Laravel, Inertia React, JavaScript, HTML, CSS, Tailwind, and more.</p>
